# Currency - Модул за показване на две валути (BGN и EUR) в OpenCart 3

## 📌 Описание
**Currency** е модул за OpenCart 3, който позволява едновременното показване на две валути – **български лев (BGN)** и **евро (EUR)**, за по-голямо удобство на клиентите.
...
## 🚀 Инсталация
1. Изтеглете последната версия на модула от [GitHub Releases](https://github.com/opencartbulgaria/currency3/releases).
...
6. Намерете **Currency3** и го инсталирайте.
...
## ⚙ Настройки
След инсталацията можете да конфигурирате модула от **Разширения** → **Модули** → **Currency3**. Там можете да включите или изключите показването на двете валути.
...
Ако срещнете проблеми или имате предложения, можете да създадете **ново Issue** в [GitHub Issues](https://github.com/opencartbulgaria/currency3/issues).
